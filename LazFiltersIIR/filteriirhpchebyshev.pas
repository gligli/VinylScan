...
type
  ...
  TFilterIIRHPChebyshev = class(TFilterIIRHP)
  private
    FRipple: TAS_Sample;
  protected
...
uses
   UASConst;
//*****************************************************************************
constructor TFilterIIRHPChebyshev.Create(AOwner: TComponent);
 begin
...
//*****************************************************************************
Destructor  TFilterIIRHPChebyshev.Destroy();
Begin
  inherited Destroy ();
end;

//*****************************************************************************
procedure TFilterIIRHPChebyshev.SetRipple(ARipple: TAS_Sample);
begin
...
//*****************************************************************************
procedure TFilterIIRHPChebyshev.SetupForChebyshev();
 var
   I: Integer;
...
procedure TFilterIIRHPChebyshev.SetupFilter();
  var
  PoleMask: Longword;
...
procedure Register;
begin
  RegisterComponents('LazFilters',[TFilterIIRHPChebyshev]);
end;
