...
type
  ...
  TFilterIIRLPButterworth = class(TFilterIIRLP)
...
{$endif}
 ...
 //*****************************************************************************
constructor TFilterIIRLPButterworth.Create(AOwner: TComponent);
 begin
...
Destructor  TFilterIIRLPButterworth.Destroy();
Begin
  inherited Destroy();
end;
...
procedure TFilterIIRLPButterworth.SetupFilter();
  var
  PoleMask: Longword;
...
procedure Register;
begin
  RegisterComponents('LazFilters',[TFilterIIRLPButterworth]);
end;
