...
var
  ...
  begin
    ...
    //f := GradientDescentMinimize(@GradientCorrect, lx, 0.01, 1e-7, Pointer(angleIdx));
    f := PowellMinimize(@PowellCorrect, lx, 1e-8, 1e-9, 0, MaxInt, Pointer(angleIdx))[0];
...
var
  ...
  var
    x: TVector;
    i, ox, cnt: Integer;
    r, sn, cs, px, py, t, cx, cy, acc, bt, skm, ct: Double;
  begin
